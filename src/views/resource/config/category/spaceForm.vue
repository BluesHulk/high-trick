      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12">
          <el-form-item label="上级类别" prop="parentId">
            <el-select v-model="form.parentId" :disabled="this.GlobalActionType != 'add'">
  ...
  watch: {
    ...
    GlobalActionType(newV, oldV) {
      if (newV == 'add') {
        ...
        this.categoryList = [
          { name: '无', id: '0' },
          { name: this.currentData.name, id: this.currentData.id }
        ];
